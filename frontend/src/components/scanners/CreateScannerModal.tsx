        ...
        <div className="px-5 py-4">
          {created ? (
            <div className="space-y-4">
              ...
              <div>
                <span className="mb-1 block text-sm font-medium text-gray-700">Heslo</span>
                <div className="flex items-center gap-2">
                  <code className="flex-1 rounded-lg bg-gray-50 px-3 py-2 font-mono text-sm text-gray-900">
                    {password}
                  </code>
                  <button
            ...
            <div className="space-y-4">
              ...
              <label className="block">
                <span className="mb-1 block text-sm font-medium text-gray-700">Meno</span>
                <input
                  type="text"
                  value={name}
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="inline-flex flex-shrink-0 items-center gap-1 rounded-lg border border-gray-300 px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50"
                    title="Vygenerovať nové heslo"
                  >
                    <RefreshCw size={15} /> Generovať
                  </button>
                </div>
                <span className="mt-1 block text-xs text-gray-400">Min. 8 znakov.</span>
              </div>
              {error && (
