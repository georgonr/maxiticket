      ...
      <div className="space-y-5">
        ...
        <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-gray-900 p-5">
          ...
          <label className="flex cursor-pointer items-start justify-between gap-4">
            ...
            >
              <span className={clsx('absolute top-0.5 h-5 w-5 rounded-full bg-white dark:bg-gray-900 shadow transition-transform', profile.marketingOptIn ? 'translate-x-[22px]' : 'translate-x-0.5')} />
            </button>
          </label>
